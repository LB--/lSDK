...
class CMvt
{
	...
	public:
		...
		virtual int            GetModuleName(LPTSTR pBuf, int bufSize)
		{
			return 0;
		}
		...
		//Load / Save
		virtual BOOL        Load(LPBYTE pBuf, DWORD dwSize, DWORD dwFlags)
		{
			return 0;
		}
		virtual BOOL        Save(LPBYTE pBuf, LPDWORD pDWSize, DWORD dwFlags)
		{
			return 0;
		}
...
class CRunMvt
{
	...
	public:
		...
		virtual DWORD        Extension(LPHO hoPtr, int function, DWORD param)
		{
			return 0;
		}
		virtual DWORD        ActionEntry(LPHO hoPtr, int action, DWORD param)
		{
			return 0;
		}
