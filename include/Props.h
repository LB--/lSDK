...
class CPropIntValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropIntValue(m_nValue);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_nValue == ((CPropIntValue *)value)->m_nValue);
		}
...
class CPropDWordValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropDWordValue(m_dwValue);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_dwValue == ((CPropDWordValue *)value)->m_dwValue);
		}
		virtual DWORD GetClassID()
		{
			return 'DWRD';
...
class CPropFloatValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropFloatValue(m_fValue);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_fValue == ((CPropFloatValue *)value)->m_fValue);
		}
		virtual DWORD GetClassID()
		{
			return 'FLOT';
...
class CPropDoubleValue : public CPropValue
{
	...
	public:
		...
		CPropDoubleValue(double dValue)
		{
			m_dValue = dValue;
		}
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropDoubleValue(m_dValue);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_dValue == ((CPropDoubleValue *)value)->m_dValue);
		}
		virtual DWORD GetClassID()
		{
			return 'DBLE';
...
class CPropSizeValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropSizeValue(m_cx, m_cy);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_cx == ((CPropSizeValue *)value)->m_cx && m_cy == ((CPropSizeValue *)value)->m_cy);
		}
		virtual DWORD GetClassID()
		{
			return 'SIZE';
...
class CPropInt64Value : public CPropValue
{
	...
	public:
		...
		CPropInt64Value(__int64 nValue)
		{
			m_nValue = nValue;
		}
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropInt64Value(m_nValue);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_nValue == ((CPropInt64Value *)value)->m_nValue);
		}
		virtual DWORD GetClassID()
		{
			return 'INT2';
...
class CPropPtrValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropPtrValue(m_ptr);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
			return (m_ptr == ((CPropPtrValue *)value)->m_ptr);
		}
		virtual DWORD GetClassID()
		{
			return 'LPTR';
...
class CPropDataValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropDataValue(m_dwDataSize, m_pData);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
...
class CPropAStringValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropAStringValue(m_pStr);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
...
class CPropWStringValue : public CPropValue
{
	...
	public:
		...
		virtual CPropValue *CreateCopy()
		{
			return new CPropWStringValue(m_pWStr);
		}
		virtual BOOL IsEqual(CPropValue *value)
		{
...
class CCustomProp
{
	public:
		...
		virtual CPropValue    *GetPropValue()
		{
			return NULL;
		}
